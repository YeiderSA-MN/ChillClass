...
try {
    ...
    $insertar = $conexion->prepare("INSERT INTO curso (cod_curso, descripcion, cod_academia, fecha_creacion, duracion_curso, cod_tematica, cod_estado, video) VALUES (:Codigo, :desc, :academia, :creacion, :duracion, :tematica, :estado, :video)");
