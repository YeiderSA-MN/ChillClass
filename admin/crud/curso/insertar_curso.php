...
<body class="oscuro">
  <div class="container mt-5 tx-blanco">
    ...
    <form action="ins_curso.php" method="POST">
      ...
      <div class="form-group mb-2">
        <input type="date" class="form-control" id="creacion" name="creacion" placeholder="Fecha de creación">
      </div>
      ...
      <div class="form-group mb-2">
        <input type="text" class="form-control" id="video" name="video" placeholder="Enlace del video">
      </div>
