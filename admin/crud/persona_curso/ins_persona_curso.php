...
header("location: persona_curso.php");
  ...
  if ($error == 23000) {
      echo '<script>confirmar=confirm("Este registro ya existe");
            if (confirmar)
              window.location.href="./insertar_persona_curso.php";
            else
              window.location.href="./insertar_persona_curso.php";</script>';
  } else {
