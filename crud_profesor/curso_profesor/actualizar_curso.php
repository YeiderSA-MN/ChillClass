...
$update = $conexion->prepare("UPDATE curso SET descripcion=:desc, cod_academia = :academia, fecha_creacion=:creacion, duracion_curso = :duracion, cod_tematica=:tematica, cod_estado=:estado
