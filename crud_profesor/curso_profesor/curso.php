                            ...
                            <div class="p-5 tx-blanco">
                                <div class="container ">
                                    ...
                                    if (empty($_GET['buscar'])) {
                                        ...
                                        $result = mysqli_query($dbhandle, "SELECT a.cod_curso, a.descripcion AS descripcion_curso, b.descripcion AS academia, a.fecha_creacion, a.duracion_curso, c.descripcion AS tematica, d.descripcion AS estado FROM curso a, academia b, tematica c, estado d WHERE a.cod_academia = b.cod_academia AND a.cod_tematica = c.cod_tematica AND a.cod_estado = d.cod_estado;") or die(mysqli_error($dbhandle));
                                    } else {
