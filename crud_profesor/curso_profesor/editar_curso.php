    ...
    <header class="header">
      <div class="container mt-5 tx-blanco">
        ...
        <form action="actualizar_curso.php" method="POST" class="mt-3">
          ...
          try {
            $persona = $conexion->query("SELECT a.cod_curso, a.descripcion AS descripcion_curso, b.cod_academia, b.descripcion, a.fecha_creacion, a.duracion_curso, c.cod_tematica, c.descripcion AS descripcion_2, d.cod_estado, d.descripcion AS descripcion_3 FROM curso a, academia b, tematica c, estado d WHERE a.cod_academia=b.cod_academia AND a.cod_tematica=c.cod_tematica AND a.cod_estado=d.cod_estado AND cod_curso='" . $vcodigo . "'");
