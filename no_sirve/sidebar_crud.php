<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 oscuro shadow">
    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 min-vh-100">
        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <div class="container p-0">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="../../crud/curso/curso.php" class="nav-link align-items-center d-flex">
                            <i class="bi bi-mortarboard-fill me-2 tx-rosado fw-bolder"></i> <!-- Icono de Bootstrap -->
                            <span class="tx-blanco fw-bolder">Curso</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../../crud/persona/persona-1.php" data-bs-toggle="collapse" class="nav-link align-items-center d-flex">
        ...
        <div class="container pb-3">
            <a href="../../admin/usuario/usuario.php" class="btn btn-primary fw-bold tx-osuro" role="button">Cerrar <i class="fas fa-sign-out-alt"></i></a>
        </div>
    </div>
</div>